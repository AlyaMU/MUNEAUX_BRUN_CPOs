 ...
 * @author Mathilde
 */
public class Consigne_Difficile extends javax.swing.JFrame {

    /**
     * Creates new form Consigne_Difficile
     */
    public Consigne_Difficile() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consigne_Difficile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consigne_Difficile().setVisible(true);
            }
        });
    }
